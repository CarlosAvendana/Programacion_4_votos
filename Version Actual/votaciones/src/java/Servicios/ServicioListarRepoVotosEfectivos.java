package Servicios;
//  ServicioListarRepoVotosEfectivos.java
...
public class ServicioListarRepoVotosEfectivos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                _reportes = GestorReportes.obtenerInstancia().listar_votoEfectivo();
            ...
            for (Reporte p : _reportes) {
                ...
                objReporte.put("voto_efectivo", p.getVotoEfectuados());
                objReporte.put("pocertanje", p.getPorcentanjeVotoEfectuado());

                arrayReportes.put(objReporte);
            }
            _reportesFinal.put("votos_efectuados", arrayReportes);
